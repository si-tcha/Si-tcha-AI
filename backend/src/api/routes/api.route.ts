...
import { getGicProfile, updateGicProfile, getGicHarvests, createGicHarvest, getGicExpenses, createGicExpense, getGicOrders, createGicNeed } from '../../controllers/gic.controller';
...
router.post('/gic/needs', requireAuth, validate(createGicNeedSchema), createGicNeed);
