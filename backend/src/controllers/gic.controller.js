...
export async function getGicProfile(req, res) {
...
export async function updateGicProfile(req, res) {
...
export async function getGicHarvests(req, res) {
    if (req.user?.role !== 'seller' || !req.user.gicId)
        return res.status(403).json({ message: 'Accès GIC requis.' });
    try {
        const gicId = BigInt(req.user.gicId);
...
export async function createGicHarvest(req, res) {
    if (req.user?.role !== 'seller' || !req.user.gicId)
        return res.status(403).json({ message: 'Accès GIC requis.' });
...
export async function getGicExpenses(req, res) {
    if (req.user?.role !== 'seller' || !req.user.gicId)
        return res.status(403).json({ message: 'Accès GIC requis.' });
    try {
        const gicId = BigInt(req.user.gicId);
...
export async function createGicExpense(req, res) {
    if (req.user?.role !== 'seller' || !req.user.gicId)
        return res.status(403).json({ message: 'Accès GIC requis.' });
...
export async function getGicOrders(req, res) {
    if (req.user?.role !== 'seller' || !req.user.gicId)
        return res.status(403).json({ message: 'Accès GIC requis.' });
    try {
        const gicId = BigInt(req.user.gicId);
