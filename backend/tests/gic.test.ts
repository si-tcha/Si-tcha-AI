...
import { getGicProfile, updateGicProfile, getGicHarvests, createGicHarvest, getGicExpenses, createGicExpense } from '../src/controllers/gic.controller';
import prisma from '../src/lib/prisma';
import { AuthRequest } from '../src/controllers/auth.controller';
